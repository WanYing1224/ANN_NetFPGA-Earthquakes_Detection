 ...
 * Project: NetProc (Final_Project)
 * Description: Network Processor with Dual-BRAM Architecture
 *
 ********************************************************/

#ifndef _REG_DEFINES_FINAL_PROJECT_
#define _REG_DEFINES_FINAL_PROJECT_

/* ========= Version Information ========= */

#define DEVICE_ID          108
#define DEVICE_MAJOR       0
#define DEVICE_MINOR       1
#define DEVICE_REVISION    0
#define DEVICE_PROJ_DIR    "Final_Project"
#define DEVICE_PROJ_NAME   "NetProc"
#define DEVICE_PROJ_DESC   "Network Processor with Dual-BRAM Architecture"
...
#define FIFO_BASE_ADDR           0x2000100
...
// Name: fifo (FIFO)
// Description: Network Processor Register Interface (Dual-BRAM Architecture)
// File: projects/Final_Project/include/ids.xml
#define FIFO_CMD_REG          0x2000100
#define FIFO_PROC_ADDR_REG    0x2000104
#define FIFO_WDATA_HI_REG     0x2000108
#define FIFO_WDATA_LO_REG     0x200010c
#define FIFO_WDATA_CTRL_REG   0x2000110
#define FIFO_RDATA_SEL_REG    0x2000114
#define FIFO_STATUS_REG       0x2000118
#define FIFO_RDATA_HI_REG     0x200011c
#define FIFO_RDATA_LO_REG     0x2000120
#define FIFO_RDATA_CTRL_REG   0x2000124
#define FIFO_POINTERS_REG     0x2000128
